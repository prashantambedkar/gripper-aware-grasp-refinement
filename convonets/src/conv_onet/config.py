...
import os
from convonets.src.encoder import encoder_dict
from convonets.src.conv_onet import models, training
from convonets.src.conv_onet import generation
from convonets.src import data
from convonets.src.common import decide_total_volume_range, update_reso
from .interface import ConvONetInterface
...
def get_model_interface(model, device):
    """
    ...
    Returns:
        ConvONetInterface
    """
    return ConvONetInterface(model, device=device)
