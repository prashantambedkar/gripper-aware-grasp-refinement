...
class ChamferDistance(torch.nn.Module):
    """
    This gives the bidirectional ChamferDistance.
    """
    def forward(self, xyz1, xyz2):
        ...
        Returns:
            cost (torch.Tensor): (b), bidirectional chamfer distance cost
        """
        dist1, dist2 = ChamferDistanceFunction.apply(xyz1, xyz2)
        return (torch.mean(dist1, axis=-1)) + (torch.mean(dist2, axis=-1))
