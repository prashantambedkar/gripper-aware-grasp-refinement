...
Made some adjustments, e.g. changed from JIT compilation to compilation in setup.py.
Also, calling ChamferDistance.forward() will directly compute the
bidirectional chamfer dist, i.e. it includes the call to
